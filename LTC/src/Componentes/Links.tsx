...
export function Links() {
    ...
    return (
        ...
        <div id="links" className="hidden sm:flex ">
                <span className="flex m-2 items-center  p-3  px-5 rounded-full group hover:text-indigo-500 hover:underline hover:underline-offset-8 transition-all ease-in-out delay-150  cursor-pointer">
            ...
            <Popover className="flex">
                ...
                <Popover.Button>
                    <span className="flex m-2 items-center group p-3 px-5 rounded-full hover:text-indigo-500 hover:underline hover:underline-offset-8 transition-all ease-in-out delay-150
            ...
            <span className="flex m-2  items-center px-5 rounded-full group hover:text-indigo-500 hover:underline hover:underline-offset-8 transition-all ease-in-out delay-350  cursor-pointer ">
